...
router.post('/register', async (req, res) => {
    try {
        ...
        const result = await db.query(
            "INSERT INTO users (email, password_hash, full_name, referral_code, join_reason, credon_pending, credon_approved, two_factor_enabled) VALUES ($1, $2, $3, $4, $5, $6, $7, $8) RETURNING id, email, full_name, referral_code",
