...
router.post('/listings/free-acquire', verifyToken, async (req, res) => {
    try {
        ...
        await db.query('INSERT INTO purchases (buyer_id, listing_id, seller_id, amount_cents, platform_fee_cents, seller_payout_cents, status) VALUES ($1, $2, $3, 0, 0, 0, $4)', [buyerId, listingId, l.seller_id, 'completed']);
...
router.post('/checkout', verifyToken, async (req, res) => {
    try {
        const userId = req.userId;
        const { cartItems, shippingAddress, deliveryMethod } = req.body;
        await db.query('BEGIN');
        ...
        for (const item of cartItems) {
            ...
            await db.query('INSERT INTO purchases (buyer_id, listing_id, seller_id, amount_cents, shipping_address, delivery_method, status) VALUES ($1, $2, $3, $4, $5, $6, $7)',
                [userId, item.listing_id, l.seller_id, l.price_cents, shippingAddress ? JSON.stringify(shippingAddress) : null, deliveryMethod || 'shipping', 'paid']);
            await db.query('INSERT INTO sales_history (listing_id, listing_title, listing_type, buyer_id, seller_id, amount_cents, platform_fee_cents, seller_payout_cents) VALUES ($1, $2, $3, $4, $5, $6, 0, $6)',
                [item.listing_id, l.title, l.type, userId, l.seller_id, l.price_cents]);
